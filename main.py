...
def generate_answer(state: State):
    ...
    - Umumiy, tushunarsiz, kimyosanoat doirasidan tashqari savollar kelganda savolni aniqlashtirish uchun takliflar bering, takliflarda faqat kimyosanoat bo'yicha takliflar bering. Takliflar uchun quyidagi yo'nalishlardan foydalaning:
