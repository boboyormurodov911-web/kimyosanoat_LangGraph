...
def generate_sql(state: State):
    ...
    - Tashkilotlarning ishlab chiqargan mahsulotlari miqdori haqidagi ma'lumotlarni olish uchun warehouse_stock_income_output jadvalini tanlash kerak.
    """
...
def generate_answer(state: State):
    ...
    - Sonli qiymatlarni foydalanuvchiga tushunarli tarzda chiqarish kerak. Ya'ni javob ko'p xonali sonlarda chiqsa, masalan: 2192345342.03 chiqsa uni o'qishga oson qilib har uchta sonni orasida bo'sh joy qoldirib chiqarish kerak, ya'ni 2 192 345 342.03. TO_CHAR funksiyasidan foydalanayotganda har doim 15 xonali sonlar uchun maskadan foydalaning, chunki qiymatlar milliardlarda ham chiqishi mumkin, taxminan shunaqa bo'ladi: TO_CHAR((qiymat), FM999G999G999G999G999D99)
